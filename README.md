...
TEAM_8302 | 2025 E.SUN AI Challenge. An AI program for detecting suspicious (alert) bank accounts.
...
要依賴套件包含：torch, torch_geometric, pandas, numpy, scikit-learn (joblib)。
